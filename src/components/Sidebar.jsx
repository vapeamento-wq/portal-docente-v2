...
const Sidebar = ({ docente, selectedCursoIdx, setSelectedCursoIdx }) => {
    return (
        <aside className="p-8 h-fit animate-[fadeInUp_0.5s_ease-out] w-full md:w-auto flex md:block overflow-x-auto gap-4 md:gap-0 bg-white/95 dark:bg-slate-800/95 backdrop-blur-md border border-white/20 dark:border-white/5 shadow-lg rounded-[20px] transition-colors duration-300">
